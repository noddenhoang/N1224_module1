...
public class EmployeeInformation3 {
    ...
    public static void main(String[] args) {
        ...
        String s;
        System.out.println("Bạn có muốn nhập tiếp hay không? (gõ 'Y' để tiếp tục, 'N' để dừng): ");
        s = sc.nextLine();
            ...
            if (s.equalsIgnoreCase("N")) {
                ...
                if (s.equalsIgnoreCase("N")) {
                    ...
                    if (s.equalsIgnoreCase("N")) {
                        ...
                        System.out.println("Bạn có muốn nhập tiếp hay không? (gõ 'Y' để tiếp tục, 'N' để dừng): ");
                        s = sc.nextLine();
                        System.out.println("Bạn đã nhập đủ 5 người!");
                        outputEmployeeInformation1();
                        outputEmployeeInformation2();
                        outputEmployeeInformation3();
                        outputEmployeeInformation4();
